...
burgers.addEventListener("click", function() {
    menuItems.innerHTML = 
            `<p>Burgers served with Side Fries (Beef)</p>
                <div class="item-type">
                    <div class="item">
                    <img src="" alt="">
                    <h3>Quarter Pounder</h3>
                    <p>₱100.00</p>
                    <button class="add-to-cart" data-name="Quarter Pounder" data-price="100">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Cheezy QPB</h3>
                    <p>₱120.00</p>
                    <button class="add-to-cart" data-name="Cheezy QPB" data-price="120">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Bacon QPB</h3>
                    <p>₱140.00</p>
                    <button class="add-to-cart" data-name="Bacon QPB" data-price="140">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Double Decker</h3>
                    <p>₱170.00</p>
                    <button class="add-to-cart" data-name="Double Decker" data-price="170">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Chicken Burger</h3>
                    <p>₱100.00</p>
                    <button class="add-to-cart" data-name="Chicken Burger" data-price="100">Add to Cart</button>
                </div>
            </div>`;
});
...
sausages.addEventListener("click", function() {
    menuItems.innerHTML = 
            `<p>Hungarian Sausages served with Side Fries (Beef)</p>
                <div class="item-type">
                    <div class="item">
                    <img src="" alt="">
                    <h3>Classic Hungarian</h3>
                    <p>₱89.00</p>
                    <button class="add-to-cart" data-name="Classic Hungarian" data-price="89">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Cheezy Hungarian</h3>
                    <p>₱89.00</p>
                    <button class="add-to-cart" data-name="Cheezy Hungarian" data-price="89">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Spicy Cheese</h3>
                    <p>₱89.00</p>
                    <button class="add-to-cart" data-name="Spicy Cheese" data-price="89">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Original Spicy</h3>
                    <p>₱89.00</p>
                    <button class="add-to-cart" data-name="Original Spicy" data-price="89">Add to Cart</button>
                </div>
            </div>`;
});
...
pasta.addEventListener("click", function() {
    menuItems.innerHTML = 
            `<p>Pasta served with Toasted Bread</p>            
            <div class="item-type">
                    <div class="item">
                    <img src="" alt="">
                    <h3>Italian Spaghetti (Beef)</h3>
                    <p>₱79.00</p>
                    <button class="add-to-cart" data-name="Italian Spaghetti (Beef)" data-price="79">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Creamy Carbonara</h3>
                    <p>₱79.00</p>
                    <button class="add-to-cart" data-name="Creamy Carbonara" data-price="79">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Chicken Pesto</h3>
                    <p>₱79.00</p>
                    <button class="add-to-cart" data-name="Chicken Pesto" data-price="79">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Spicy Tuna Pasta</h3>
                    <p>₱79.00</p>
                    <button class="add-to-cart" data-name="Spicy Tuna Pasta" data-price="79">Add to Cart</button>
                </div>
            </div>`;
});
...
yakultSeries.addEventListener("click", function() {
    menuItems.innerHTML =
            ...
            <div class="item-type">
                <div class="item">
                    <img src="" alt="">
                    <h3>Lemon Yakult (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Lemon Yakult (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Orange Yakult (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Orange Yakult (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Classic Yakult Milktea (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Classic Yakult Milktea (22oz)" data-price="85">Add to Cart</button>
                </div>
            </div>`;
});
    ...
    menuItems.innerHTML =
            ...
            <div class="item-type">
                <div class="item">
                    ...
                    <h3>French Fries</h3>
                    <p>₱65.00</p>
                    <button class="add-to-cart" data-name="French Fries" data-price="65">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Cheese Sticks (Homemade)</h3>
                    <p>₱65.00</p>
                    <button class="add-to-cart" data-name="Cheese Sticks (Homemade)" data-price="65">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Cheese Sticks (Homemade)</h3>
                ...
                <div class="item">
                    <img src="" alt="">
                    <h3>Steamed Siomai</h3>
                    <p>₱45.00</p>
                    <button class="add-to-cart" data-name="Steamed Siomai" data-price="45">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Lumpiang Shanghai</h3>
                    <p>₱70.00</p>
                    <button class="add-to-cart" data-name="Lumpiang Shanghai" data-price="70">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Chicken Nuggets Ala Carte</h3>
                    <p>₱99.00</p>
                    <button class="add-to-cart" data-name="Chicken Nuggest Ala Carte" data-price="99">Add to Cart</button>
                </div>
            </div>`;
});
...
milktea.addEventListener("click", function() {
    menuItems.innerHTML = 
            `<p>Flavored Milktea comes with Tapioca Pearls</p>
            <div class="item-type">
                <div class="item">
                    <img src="" alt="">
                    <h3>Classic (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Classic (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Wintermelon (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Wintermelon (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Okinawa (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Okinawa (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Dark Chocolate (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Dark Chocolate (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Salted Caramel (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Salted Caramel (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Choco Hazelnut (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Choco Hazelnut (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Choco Caramel (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Choco Caramel (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Cookies & Cream (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Cookies & Cream (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Strawberry (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Strawberry (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Taro (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Taro (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Caramel (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Caramel (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Hokkaidou (22oz)</h3>
                    <p>₱85.00</p>
                    <button class="add-to-cart" data-name="Hokkaidou (22oz)" data-price="85">Add to Cart</button>
                </div>
                <div class="item">
                    <img src="" alt="">
                    <h3>Matcha (22oz)</h3>
                    <p>₱95.00</p>
                    <button class="add-to-cart" data-name="Matcha (22oz)" data-price="95">Add to Cart</button>
                </div>
            </div>`;
});
...
menuItems.addEventListener("click", function(e) {
    if (e.target.classList.contains("add-to-cart")) {
        ...
        const existingItem = listOfOrders.find(item => item.name === name);
...
const button = document.querySelectorAll("#menu-categories button");
